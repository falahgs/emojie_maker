...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Navigation Bar */}
      <nav className="bg-white shadow-md dark:bg-gray-800 fixed w-full z-50">
      ...
      <main className="flex-grow mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="w-full max-w-md mx-auto space-y-4">
            ...
            {image && (
              <img src={image} alt="Generated emoji" className="w-full rounded-lg" />
            )}
          </div>
        </div>
      </main>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="mt-4 space-y-2">
                <Link href="/portfolio" className="block text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Portfolio
                </Link>
                <Link href="/blog" className="block text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Blog
                </Link>
                <Link href="/resume" className="block text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Resume
                </Link>
              </div>
            </div>
